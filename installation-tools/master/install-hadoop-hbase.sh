...
for host in `cat h.slaves`; do
 ...
 ssh $host yum install hadoop hadoop-yarn-nodemanager hadoop-hdfs-datanode hadoop-mapreduce  hbase-regionserver java-1.8.0-openjdk-devel.x86_64 hadoop-lzo -y
done
